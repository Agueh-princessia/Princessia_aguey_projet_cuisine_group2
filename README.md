...
Ce site présente notre menu ainsi que les prix des repas, une rubrique qui parle de notre histoire et nos valeurs, los horaires d’ouvertures de notre restaurant, pourquoi choisir notre restaurant et le retour de nos clients. Sur ce site, vous pouvez également nous contacter directement (par email, par téléphone) et comment passer votre commande.
Fonctionnalités
- Présentation du restaurant : Découvrez notre histoire et nos valeurs,notre contact, et les retours clients
...
1. Clone ton dépôt :
   bash
   git clone https://github.com/Agueh-princessia/Princessia_aguey_projet_cuisine_group2.git
...
git branch -M main
git remote add origin https://github.com/Agueh-princessia/Princessia_aguey_projet_cuisine_group2.git
...
Après ça ton site sera accessible sur : https://github.com/Agueh-princessia/Princessia_aguey_projet_cuisine_group2.git
